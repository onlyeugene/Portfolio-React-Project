...
const HomeAbout = () => {
  return (
    <div className='w-full border-t-[1px] gap-[9.4rem] xl:flex justify-center border-[#484848] md:px-[5rem] px-[1rem] py-[1rem] md:py-[5rem] bg-black text-white'>
        <h1 className='xl:text-[90px] text-[90px] w-full py-4 md:block hidden'>ABOUT ME</h1>
